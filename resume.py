...
demo = gr.Interface(
    ...
    outputs=[
        ...
        gr.Markdown(label="Suggestion And Best Fit Role")
    ],
    title="Resume Analyzer based on JD",
    description="Upload your resume and paste the job description to get your ATS match score and recommandation",
    theme="default"
)
